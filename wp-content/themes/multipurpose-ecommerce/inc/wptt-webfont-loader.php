...
if ( ! class_exists( 'Multipurpose_Ecommerce_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Multipurpose_Ecommerce_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Multipurpose_Ecommerce_WPTT_WebFont_Loader( $url );
